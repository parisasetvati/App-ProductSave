...
const Search = ({searchValue,onSearch }) => {
    ...
    <div className="w-full flex justify-between items-center px-8 mt-12 max-w-full ">
        ...
        <input className="bg-transparent border text-slate-300 border-slate-500 rounded-lg px-3 py-1 ml-8 max-[400px]:w-10" type="text" value={searchValue} onChange={onSearch}></input>
    </div>
