      ...
      <Layout productlist={productlist}>
        <Routes>
          <Route
            path="/"
            element={
              <div className="   w-full flex flex-col items-center justify-center mt-24 max-w-full flex-1 min-h-screen">
          ...
          <Route
            path="/ProductList"
            element={
              <div className=" w-full flex flex-col items-center justify-center mt-24 flex-1 min-h-screen">
                <section className="mx-6 my-8 w-3/5">
                  <h1 className=" text-slate-200 text-lg font-bold border-b my-4 mx-10 py-4  border-slate-400 max-w-full max-[640px]:text-sm">
                    Filter Product
                  </h1>
