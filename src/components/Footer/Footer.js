...
const Footer = () => {
    return ( 
        <footer className="
        bg-slate-800 w-full h-1/5 text-slate-300 static bottom-0  ">
            <div className="flex justify-between items-center px-28 py-3 max-[768px]:px-2 ">
               ...
               <li className="my-1">     <NavLink to="/"><span className="flex flex-row items-center border-b-2 rounded-md px-1 border-slate-300 hover:text-slate-400 hover:border-slate-500"><FaLinkedin className="mr-3"/>Linkedin</span></NavLink></li>
                ...
                <div className="flex flex-col justify-center items-center text-sm max-[768px]:mx-8 max-[768px]:text-xs">

                
            <span className="text-slate-300 font-bold pb-3 ">producer: </span> 
            <span className="text-slate-300 font-bold pb-3">Parisa Setvati Ragheb</span>
